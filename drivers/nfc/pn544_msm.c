		...
		const struct i2c_device_id *id)
{
	...
	platform_data = kzalloc(sizeof(struct pn544_i2c_platform_data), GFP_KERNEL);
	 
	
	pr_err("quark pn544_parse_dt enter \n");
	...
	pr_err("quark pn544_parse_dt exit \n");
