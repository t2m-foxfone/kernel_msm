...
#define MAX_LIMIT_VALUE_GROUP1 3250 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP1 1100		// screen min limit
#define MAX_LIMIT_KEY_GROUP1 2000		// key_val max limit
#define MIN_LIMIT_KEY_GROUP1 750		// key_val min limit
#define UNIFORMITY_GROUP1 60 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP1 {\
0x00,0x1C,0x02,0xC0,0x03,0x05,0x05,0x11,0x01,0x08,\
0x14,0x05,0x50,0x3C,0x03,0x05,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x89,0x08,0x0B,\
0x37,0x00,0xB8,0x08,0x00,0x00,0x00,0x9A,0x03,0x1D,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x2C,0x6E,0x94,0xD5,0x02,0x05,0x00,0x00,0x04,\
0x8F,0x30,0x00,0x7A,0x3A,0x00,0x6A,0x45,0x00,0x5C,\
0x53,0x00,0x52,0x64,0x00,0x52,0x00,0x30,0x00,0x00,\
0xF0,0x80,0x50,0xFF,0xFF,0x27,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
...
#define MAX_LIMIT_VALUE_GROUP2 1800 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP2 1000		// screen min limit
#define MAX_LIMIT_KEY_GROUP2 1500		// key_val max limit
...
#define MAX_LIMIT_VALUE_GROUP3 1800 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP3 1000		// screen min limit
#define MAX_LIMIT_KEY_GROUP3 1500		// key_val max limit
#define MIN_LIMIT_KEY_GROUP3 800		// key_val min limit
...
#define MAX_LIMIT_VALUE_GROUP4 2650 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP4 675		// screen min limit
...
#define MAX_LIMIT_VALUE_GROUP5 2500 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP5 750		// screen min limit
#define MAX_LIMIT_KEY_GROUP5 2350		// key_val max limit
#define MIN_LIMIT_KEY_GROUP5 750		// key_val min limit
...
#define TEST_RAWDATA_MODE       //not debug mode
#ifdef TEST_RAWDATA_MODE

#define REPORT_TEST_RESULT_INFO(fmt, args...)       do{ memset(tmp_info_line, '\0', 80);\
...
#define PRINTF_INFO_LINE_INFO(fmt, args...)       do{ } while(0)
...
#define REPORT_TEST_RESULT_INFO(fmt, args...)   do{ } while(0)
...
s32 gtp_parse_config(struct i2c_client *client)
{
    ...
    for (i = 0; i < 4; ++i)
    {
		...
		SET_INFO_LINE_INFO("key_val[%d] = 0x%02x\n", i+1, key_val);
        if ((key_pos != 0))
        {
            key_is_isolated = 0;
...
static void gtp_key_max_test(u16 *raw_buf)
{
    ...
    for (i = gt9xx_sc_pxl_cnt; i < gt9xx_pixel_cnt; ++i)
    {
        ...
        if (raw_buf[i] > max_limit_key)//i=181
        {
            PRINTF_INFO_LINE_INFO("max_key:%d,i=%d\n",raw_buf[i],i);
...
static void gtp_key_min_test(u16 *raw_buf)
{
    ...
    for (i = gt9xx_sc_pxl_cnt; i < gt9xx_pixel_cnt; ++i)
    {
        ...
        if (raw_buf[i] < min_limit_key) //i=181
        {
            PRINTF_INFO_LINE_INFO("min key:%d,i=%d\n",raw_buf[i],i);
...
{    
    ...
    else
    {
     ...
     {
        PRINTF_INFO_LINE_INFO("uniformity:%d\n",uniformity);
