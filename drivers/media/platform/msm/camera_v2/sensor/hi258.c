...
static struct msm_camera_i2c_reg_conf hi258_recommend_settings[] = {
	...
	{0x11, 0x92}, //Windowing On + 1Frame Skip
...
{0x87, 0xf4}, 
{0x88, 0x07}, //EXP Max 60hz 12.00 fps 
{0x89, 0xa1}, 
{0x8a, 0x20}, 
{0xa5, 0x07}, //EXP Max 50hz 12.50 fps 
{0xa6, 0x53}, 
{0xa7, 0x00}, 
{0x8B, 0xea}, //EXP100 
{0x8C, 0x60}, 
...
{0x03, 0x48},
{0x30, 0x05},//0x06
{0x31, 0x00}, //0x40  long_packet word count
...
static struct msm_camera_i2c_reg_conf HI258_reg_saturation[6][3] = {
	{
		{0x03, 0x10},
		{0x61, 0x1c},
		{0x62, 0x1c},      //level 0
...
static struct msm_camera_i2c_reg_conf HI258_reg_contrast[6][3] = {
	{
		{0x03, 0x10},
		{0x13, 0x03},
		{0x48, 0x1c},  //level 0
...
static struct msm_camera_i2c_reg_conf HI258_reg_sharpness[6][9] = {
	...
	}, /* SHARPNESS LEVEL 3   default*/
	{
		{0x03, 0x13},
              ...
              {0x85, 0x00},
              {0x92, 0x33}, //Sharp2D Slop n/p
              {0x93, 0x50}, //Sharp2D LClip
              {0x94, 0x04}, //Sharp2D HiClip1 Th
              {0x95, 0xf0}, //Sharp2D HiClip2 Th
	}, /* SHARPNESS LEVEL 4*/
	{
		{0x03, 0x13},
              {0x81, 0x07}, //Sharp2D Clip/Limit
              {0x82, 0xb3}, //Sharp2D Filter
              {0x83, 0x00}, //Sharp2D Low Clip
              {0x85, 0x00},
              {0x92, 0x33}, //Sharp2D Slop n/p
              {0x93, 0x70}, //Sharp2D LClip
...
static const struct of_device_id hi258_dt_match[] = {
	{.compatible = "e-welly,hi258", .data = &hi258_s_ctrl},
	{}
};
